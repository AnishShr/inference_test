...
def load_camera_transform():
    with open("src/inference_test/src/inference_test/config/tf_base_link_to_cam_opt_frame.yaml", 'r') as tf_yaml_file:
...
def load_camera_model():
    with open("src/inference_test/src/inference_test/config/camera_info.yaml", 'r') as camera_info_yaml_file:
